...
import ProfArchiveView from "./pages/ProfArchiveView";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/prof/archives/:archiveId" element={<RequireProf><ProfArchiveView /></RequireProf>} />
        <Route path="/prof/archives/:archiveId/eleve/:studentId" element={<RequireProf><ProfArchiveFiche /></RequireProf>} />
